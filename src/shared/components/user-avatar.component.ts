...
export class UserAvatarComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        if (self.user.uid === 'default' || !firebaseConnected) {
            ...
            self.dataService.getStorageRef().child('images/2s8OeyhsQG2LZXRcHsUe_profile-icon-male-avatar-portrait-casual-person-silhouette-face-flat-design-vector-46846328.jpg').getDownloadURL().then(function (url) {
    ...
    getUserImage() {
        ...
        return self.dataService.getStorageRef().child('images/2s8OeyhsQG2LZXRcHsUe_profile-icon-male-avatar-portrait-casual-person-silhouette-face-flat-design-vector-46846328.jpg').getDownloadURL();
    }
}